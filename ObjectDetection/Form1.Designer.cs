namespace ObjectDetection
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Click += new System.EventHandler(this.loadBttn_Click);
			// 
			// button2
			// 
			...
			this.button2.Text = "Detect Object";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.objDtct_Click);
			// 
			// Form1
			// 
